...
<div id="content" class="content">
    ...
    <div class="btn-group" style="margin-bottom:1%">
        <button class="btn btn-success" onclick="rekap_slip()"><i class="fas fa-upload"></i> Proses Slip</button>
        ...
        var handleDataTableFixedHeader = function() {
            ...
            if ($('#data-table-fixed-header').length !== 0) {
                var table=$('#data-table-fixed-header').DataTable({
                    ...
                    responsive: true,
                    ajax:"{{ url('slip/get_data')}}?bulan={{$bulan}}&tahun={{$tahun}}",
					columns: [
                ...
                $.ajax({
                    ...
                    success: function(msg){
                        ...
                        if(bat[1]=='ok'){
                            ...
                            location.assign("{{ url('slip')}}?bulan="+bat[2]+"&tahun="+bat[3]);
