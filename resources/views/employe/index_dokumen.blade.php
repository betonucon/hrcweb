...
<div id="content" class="content">
    <ol class="breadcrumb float-xl-right">
        ...
        <li class="breadcrumb-item active">Employe Dokumen</li>
    </ol>
    <h1 class="page-header">Employe Dokumen <small> (tampilan daftar karyawan)</small></h1>
    
    <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
        <div class="panel-heading ui-sortable-handle">
            <h4 class="panel-title">Daftar Employe Dokumen</h4>
        ...
        var handleDataTableFixedHeader = function() {
            ...
            if ($('#data-table-fixed-header').length !== 0) {
                var table=$('#data-table-fixed-header').DataTable({
                    ...
                    responsive: true,
                    ajax:"{{ url('employe/get_data_dokumen')}}",
					columns: [
