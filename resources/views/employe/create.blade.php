            ...
            <div class="panel-body panel-form" style="background: #c1c1c7; padding: 1% !important;">
                <form class="form-horizontal form-bordered" id="mydata" method="post" action="{{ url('employe') }}" enctype="multipart/form-data" >
                    ...
                    <ul class="nav nav-tabs">
						<li class="nav-item">
							<a href="#default-tab-1" data-toggle="tab" class="nav-link active">
								<span class="d-sm-none">1.General</span>
								<span class="d-sm-block d-none">1.General</span>
							</a>
						</li>
						<li class="nav-item">
							<a href="#default-tab-4" data-toggle="tab" class="nav-link">
								<span class="d-sm-none">2.Kontrak</span>
								<span class="d-sm-block d-none">2.Kontrak</span>
							</a>
						</li>
						<li class="nav-item">
							<a href="#default-tab-5" data-toggle="tab" class="nav-link">
								<span class="d-sm-none">3.Payroll</span>
								<span class="d-sm-block d-none">3.Payroll</span>
							</a>
						</li>
						<li class="nav-item">
							<a href="#default-tab-6" data-toggle="tab" class="nav-link">
								<span class="d-sm-none">4.Tunjangan Asset</span>
								<span class="d-sm-block d-none">4.Tunjangan Asset</span>
							</a>
						</li>
                    ...
                    <div class="tab-content">
						<!-- begin tab-pane -->
						<div class="tab-pane fade active show" id="default-tab-1" style="background: #e2e2eb; border: solid 1px #e9e9e9;">
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
                                    <a href="#subsub-tab-1" data-toggle="tab" class="nav-link active">
                                        <span class="d-sm-none">1.Personal</span>
                                        <span class="d-sm-block d-none">1.Personal</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="#subsub-tab-2" data-toggle="tab" class="nav-link">
                                        <span class="d-sm-none">2.Pendidikan</span>
                                        <span class="d-sm-block d-none">2.Pendidikan</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="#subsub-tab-3" data-toggle="tab" class="nav-link">
                            ...
                            <div class="tab-content" style="margin-bottom: 0px;">
                                <div class="tab-pane fade active show" id="subsub-tab-1">
                                    <div class="row">
                                ...
                                <div class="tab-pane fade" id="subsub-tab-2">
                                    <div class="row">
                                        <div class="col-xl-12 ui-sortable">
                                            <div class="form-group row">
                                ...
                                <div class="tab-pane fade" id="subsub-tab-3">
                                    <div class="row">
                                        <div class="col-xl-12 ui-sortable">
                        ...
                        <div class="tab-pane fade" id="default-tab-4">
                            <div class="col-xl-12 ui-sortable">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label">BPJS Kesehatan & Tenaga Kerja</label>
                                    <div class="col-lg-3">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label">BANK & No Rekening</label>
                                    <div class="col-lg-4">
                                        <select class="default-select2 form-control form-control-sm" name="bank">
                                            
                                            <option value="">Pilih</option>
                                            @foreach(get_bank() as $bank)
                                                <option value="{{$bank->id}}" @if($data->bank==$bank->id) selected @endif >{{$bank->bank}}  ({{$bank->keterangan}})</option>
                                            @endforeach
                                        
                                        </select>
                                    </div>
                                    <div class="col-lg-3">
                                        <input type="text" name="no_rek" value="{{$data->no_rek}}" class="form-control form-control-sm" placeholder="ketik disini...">
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="default-tab-6">
                            <div class="row">
                                ...
                                <div class="col-xl-12 ui-sortable">
                                    ...
                                    <span id="tambahaddasset" class="btn btn-sm btn-primary">Tambah Asset</span>
                                    <div class="widget-list widget-list-rounded m-b-30" style="margin-top:2%" data-id="widget">
                                        @if($id>0)
                                            @foreach(get_asset($data->no_ktp) as $xc=>$ser)
                                                <a href="javascript:;" class="widget-list-item" style="background: #d8fbd4;border:solid 1px #fff">
                                                    <div class="widget-list-content">
                                                        <h4 class="widget-list-title">{{$xc+1}}. Kode Asset : {{$ser->kode_asset}} <br> &nbsp;&nbsp;&nbsp;&nbsp;Nama Asset: {{$ser->nama_asset}} <br> &nbsp;&nbsp;&nbsp;&nbsp;Jumlah: {{$ser->jumlah}}</h4>
                                                    </div>
                                                    <div class="widget-list-action text-right" onclick="delete_asset({{$ser->id}})" title="hapus">
                                                        <i class="fas fa-trash text-red"></i>
                                                    </div>
                                                </a>
                                            @endforeach
...
@push('datatable')
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var nemer = 1;
            $("#tambahaddasset").click(function(){
                var no = nemer++;
                $("#upload_asset").append('<div class="form-group row">'
                                                    +'<label class="col-lg-1 col-form-label"> '+no+'</label>'
                                                    +'<div class="col-lg-3">'
                                                        +'<input type="text" name="kode_asset[]"  class="form-control form-control-sm" placeholder="Kode Asset">'
                                                    +'</div>'
                                                    +'<div class="col-lg-7">'
                                                        +'<input type="text" name="nama_asset[]"  class="form-control form-control-sm" placeholder="Nama Asset">'
                                                    +'</div>'
                                                    +'<div class="col-lg-1">'
                                                        +'<input type="number" name="jumlah[]"  class="form-control form-control-sm" value="1">'
                                                    +'</div>'
                                                +'</div>');
            });
        });
