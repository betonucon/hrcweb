...
<div id="content" class="content">
    ...
    <h1 class="page-header">Jabatan <small> (tampilan daftar karyawan)</small></h1>
    <div class="btn-group" style="margin-bottom:1%">
        <button class="btn btn-sm btn-success" onclick="location.assign(`{{url('master/jabatan/create')}}?id=0`)"><i class="fas fa-plus"></i> Tambah </button>
        ...
        var handleDataTableFixedHeader = function() {
            ...
            if ($('#data-table-fixed-header').length !== 0) {
                var table=$('#data-table-fixed-header').DataTable({
                    ...
                    responsive: true,
                    ajax:"{{ url('master/jabatan/get_data')}}",
					columns: [
