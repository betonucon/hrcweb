...
<div id="content" class="content">
    <ol class="breadcrumb float-xl-right">
        ...
        <li class="breadcrumb-item active">Form Group</li>
    </ol>
    <h1 class="page-header">Form Group <small>(Penginputan master group)</small></h1>
        ...
        <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
            ...
            <div class="panel-heading ui-sortable-handle">
                <h4 class="panel-title">FORM group</h4>
            ...
            <div class="panel-body panel-form" style="background: #c1c1c7; padding: 1% !important;">
                <form class="form-horizontal form-bordered" id="mydata" method="post" action="{{ url('master/group') }}" enctype="multipart/form-data" >
                    @csrf 
                    <!-- <input type="submit"> -->
						...
						<div class="tab-pane fade active show" id="default-tab-1">
                            <div class="col-xl-12 ui-sortable">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" name="group" value="{{$data->group}}" class="form-control form-control-sm" placeholder="ketik disini...">
                                    </div>
                                </div>
        ...
        <div class="btn-group" style="margin-bottom:1%">
            <button class="btn btn-sm btn-danger" onclick="location.assign(`{{url('master/group')}}`)"><i class="fas fa-arrow-alt-circle-right fa-flip-horizontal"></i> Kembali </button>
                        ...
                        if(bat[1]=='ok'){
                            ...
                            swal("Success! Your data has been save!", {
                                    ...
                                    @if($id>0)
                                        location.reload();
                                    @else
                                        location.assign("{{url('master/group')}}");
                                    @endif
