...
<div id="content" class="content">
    ...
    <h1 class="page-header">Form Jabatan <small>(Penginputan master jabatan)</small></h1>
        ...
        <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
            ...
            <div class="panel-heading ui-sortable-handle">
                <h4 class="panel-title">FORM jabatan</h4>
                    ...
                    <ul class="nav nav-tabs">
						<li class="nav-item">
							<a href="#default-tab-1" data-toggle="tab" class="nav-link active">
								<span class="d-sm-none">Jabatan</span>
								<span class="d-sm-block d-none">Jabatan</span>
							</a>
						</li>
        ...
        <div class="btn-group" style="margin-bottom:1%">
            <button class="btn btn-sm btn-danger" onclick="location.assign(`{{url('master/jabatan')}}`)"><i class="fas fa-arrow-alt-circle-right fa-flip-horizontal"></i> Kembali </button>
                        ...
                        if(bat[1]=='ok'){
                            ...
                            swal("Success! Your data has been save!", {
                                    ...
                                    @if($id>0)
                                        location.reload();
                                    @else
                                        location.assign("{{url('master/jabatan')}}");
                                    @endif
